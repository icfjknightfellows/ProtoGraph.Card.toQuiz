	  ...
	  _createClass(Quiz, [{
	    ...
	    value: function componentDidMount() {
	      ...
	      if (this.state.fetchingData) {
	        _axios2.default.all([_axios2.default.get(this.props.dataURL), _axios2.default.get(this.props.schemaURL), _axios2.default.get(this.props.configURL), _axios2.default.get(this.props.configSchemaURL)]).then(_axios2.default.spread(function (cardData, cardSchema, optionalConfig, optionalConfigSchema) {
	          var stateVar = {
	            fetchingData: false,
	            dataJSON: {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement('img', { src: this.props.baseURL + '/images/clock-large.png' })
	          ),
	          _react2.default.createElement(
	            'div',
	    ...
	    value: function renderMainContainerContent(cards) {
	      ...
	      return _react2.default.createElement(
	        'div',
	        { id: 'protograph_toQuiz', className: 'quiz-container' },
	        _react2.default.createElement(
	          'div',
	          ...
	          links = relatedLinks.map(function (d, i) {
	            return _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                ...
	                d.related_article_links ? _react2.default.createElement('img', { src: '' + d.link_image.image, className: 'link-img' }) : undefined,
	                _react2.default.createElement(
	                  'div',
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              ...
	              _react2.default.createElement('img', { className: 'result-img', src: this.props.baseURL + '/images/cup.png' }),
	              _react2.default.createElement(
	                'div',
	            ...
	            _react2.default.createElement(
	              ...
	              this.props.cardConfigs.revisit_answers ? _react2.default.createElement(
	                ...
	                _react2.default.createElement('img', { className: 'card-button-img', src: this.props.baseURL + '/images/revisit-icon.png' }),
	                _react2.default.createElement(
	                  'div',
	              ...
	              _react2.default.createElement(
	                ...
	                _react2.default.createElement('img', { className: 'card-button-img', src: this.props.baseURL + '/images/replay.png' }),
	                _react2.default.createElement(
	                  'div',
	                  { className: 'card-button-text' },
	                  'Play Again'
	              ...
	              this.props.cardConfigs.social_share ? _react2.default.createElement(
	                ...
	                _react2.default.createElement('img', { className: 'card-button-img', src: this.props.baseURL + '/images/share.png' }),
	                _react2.default.createElement(
	                  'div',
	                  { className: 'card-button-text' },
	                  'Share'
	  ...
	  _createClass(QuestionCard, [{
	    ...
	    value: function renderTimer() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement('img', { className: 'timer-img', src: this.props.baseURL + '/images/clock-small.png' })
	      );
	    }
	  }, {
	    key: 'render',
	          ...
	          _react2.default.createElement(
	            ...
	            this.props.isMobile ? _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                ...
	                _react2.default.createElement('img', { src: this.props.baseURL + '/images/swipe-up.gif' })
	              ),
	              _react2.default.createElement(
	                'div',
	  ...
	  _createClass(EditQuiz, [{
	    ...
	    value: function onChangeHandler(_ref) {
	      ...
	      switch (this.state.step) {
	        ...
	        case 4:
	          this.setState(function (prevStep, prop) {
	            var resultCardData = formData,
	                dataJSON = prevStep.dataJSON;

	            dataJSON.result_card_data = _this3.processResultData(resultCardData, dataJSON.mandatory_config.quiz_type);
	            console.log(dataJSON.result_card_data, ":::::::::::");
	            return {
	              updatingQuiz: true,
	              dataJSON: dataJSON,
	    ...
	    key: 'getReferenceFormData',
	    value: function getReferenceFormData() {
	        ...
	        return _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                'div',
	                { className: 'four wide column proto-card-form ' + this.setScrollClass() },
	                _react2.default.createElement(
	                  'div',
	                  null,
	                  _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                'div',
	                { id: 'protograph_embed_editQuiz', className: 'twelve wide column proto-card-preview proto-share-card-div' },
	                this.renderQuiz()
	              )
	            )
	          )
